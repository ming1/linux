 ...
 * @param idesc An ingress packet descriptor.
 */
static inline uint32_t gxio_mpipe_idesc_get_flow_hash(gxio_mpipe_idesc_t *
						      idesc)
{
 ...
 * @param idesc An ingress packet descriptor.
 */
static inline uint16_t gxio_mpipe_idesc_get_ethertype(gxio_mpipe_idesc_t *
						      idesc)
{
 ...
 * @param idesc An ingress packet descriptor.
 */
static inline unsigned int gxio_mpipe_idesc_get_l3_length(gxio_mpipe_idesc_t *
							  idesc)
{
	unsigned int xfer_size = idesc->l2_size;
 ...
 * @param idesc An ingress packet descriptor.
 */
static inline unsigned int gxio_mpipe_idesc_get_l4_length(gxio_mpipe_idesc_t *
							  idesc)
{
	unsigned int xfer_size = idesc->l2_size;
 ...
 * @param idesc An ingress packet descriptor.
 */
static inline void gxio_mpipe_edesc_copy_idesc(gxio_mpipe_edesc_t * edesc,
 ...
 * @return Zero on success, GXIO_ERR_INVAL if params are out of range.
 */
extern int gxio_mpipe_enable_notif_ring_interrupt(gxio_mpipe_context_t *context,
						  unsigned int ring);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
extern int gxio_mpipe_rules_set_priority(gxio_mpipe_rules_t *rules,
					 int priority);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
extern int gxio_mpipe_rules_set_tailroom(gxio_mpipe_rules_t *rules,
					 uint8_t tailroom);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
extern int gxio_mpipe_rules_set_capacity(gxio_mpipe_rules_t *rules,
					 uint16_t capacity);
 ...
 * @return 0 on success, or a negative error code on failure.
 */
extern int gxio_mpipe_rules_add_dmac(gxio_mpipe_rules_t *rules,
 ...
 * @return 0 on success, or a negative error code on failure.
 */
extern int gxio_mpipe_rules_add_vlan(gxio_mpipe_rules_t *rules,
 ...
 */
static inline int gxio_mpipe_iqueue_drop_if_bad(gxio_mpipe_iqueue_t *iqueue,
						gxio_mpipe_idesc_t * idesc)
{
 ...
 * @return The first reserved slot, or a negative error code.
 */
static inline int64_t gxio_mpipe_equeue_try_reserve(gxio_mpipe_equeue_t *equeue,
						    unsigned int num)
{
