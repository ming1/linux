...
EXPORT_SYMBOL_GPL(gxio_mpipe_rules_set_priority);
...
EXPORT_SYMBOL_GPL(gxio_mpipe_rules_set_tailroom);
...
EXPORT_SYMBOL_GPL(gxio_mpipe_rules_set_capacity);

int gxio_mpipe_rules_add_dmac(gxio_mpipe_rules_t *rules,
...
EXPORT_SYMBOL_GPL(gxio_mpipe_rules_add_dmac);

int gxio_mpipe_rules_add_vlan(gxio_mpipe_rules_t *rules,
...
EXPORT_SYMBOL_GPL(gxio_mpipe_rules_add_vlan);
...
int gxio_mpipe_link_open(gxio_mpipe_link_t *link, gxio_mpipe_context_t *context,
